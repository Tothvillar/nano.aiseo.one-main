...
const ImageGenerator: React.FC = () => {
    ...
    const [model, setModel] = useState('gpt-image-2-all'); // 默认选择gpt-image-2-all模型
        ...
        <div className="max-w-4xl mx-auto py-12 px-4 sm:px-6 lg:px-8">
            ...
            <div className="text-center mb-12">
                ...
                <p className="text-xl text-gray-600 dark:text-gray-300">
                    第三方AI中转站 <a target="_blank" href="https://api.aiseo.one"><b>X API</b></a>，便宜实惠，<b>￥0.12</b><small>/次</small>，HD模型<b>￥0.18</b><small>/次</small>。
                </p>
            </div>
